...
[欢迎一起探讨各自在前端开发中遇到的工程问题](https://github.com/HerbertKarajan/Fis/issues)

目录

* 系列专题
    * [前端工程——基础篇](https://github.com/HerbertKarajan/Fis/issues/10)
* 工程杂谈
    * [浅谈前端集成解决方案](https://github.com/HerbertKarajan/Fis/issues/1)
    * [前端工程与性能优化](https://github.com/HerbertKarajan/Fis/issues/3)
    * [前端开发体系建设日记](https://github.com/HerbertKarajan/Fis/issues/2)
    * [前端开发体与模块化框架](https://github.com/HerbertKarajan/Fis/issues/4)
    * [大公司里怎样开发和部署前端代码？](https://github.com/HerbertKarajan/Fis/issues/6)
    * [如何进行前端自动化测试？](https://github.com/HerbertKarajan/Fis/issues/7)
    * [md5戳计算过程](https://github.com/HerbertKarajan/Fis/issues/5)
* 示例项目
...
博客园 [@我爱吃小丸子](http://www.cnblogs.com/wangking)
